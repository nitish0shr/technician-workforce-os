import {
  ...
  ShieldCheck, Megaphone, FlaskConical, Activity, SlidersHorizontal, Waves, Filter,
} from "lucide-react";
...
export const NAV: NavItem[] = [
  ...
  { path: "/req-health", label: "Requisition Health", icon: Filter, group: "Plan", blurb: "Why hiring stalls — and what to fix vs. open more reqs" },
